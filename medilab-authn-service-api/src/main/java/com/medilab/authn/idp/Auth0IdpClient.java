...
public class Auth0IdpClient {
	...
	public String idpUserAuthn(String username, String password) {
		...
		HttpEntity<String> auth0LoginRequest = new HttpEntity<String>(userTokenBody, headers);

		//ResponseEntity<String> userTokenResp = rt.postForEntity(tokenUri, auth0LoginRequest, String.class);
		String userTokenResp = rt.postForObject(tokenUri, auth0LoginRequest, String.class);
